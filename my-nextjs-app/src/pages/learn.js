      ...
      <div className={styles.container}>
        <main className={styles.main}>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li><strong>Understanding Your Needs:</strong> Once we&rsquo;ve reviewed your financial profile and credit data, we focus on identifying the specific challenges or opportunities that are most relevant to you. This step ensures that your action plan addresses your unique situation.</li>
              ...
              <li><strong>Clear Next Steps:</strong> Youll receive a straightforward, step-by-step guide tailored to your needs. Whether its actions you can take immediately or ongoing efforts to build long-term financial health, well provide the tools and resources to help you succeed.</li>
            </ul>
          ...
          <section className={styles.section}>
            ...
            <p className={styles.paragraph}><strong>Support and Resources:</strong> At Noreg, were committed to empowering your financial journey with comprehensive tools, dedicated support, and a thriving community to help you succeed. Heres what we offer:</p>
            <ul className={styles.list}>
              <li><strong>A Team Thats Here for You:</strong> Our team at Noreg is made up of passionate professionals with one goal: helping you take charge of your financial future. From credit-building strategies to personalized assistance, were here to guide you every step of the way.</li>
              ...
              <li><strong>A Seamless User Experience:</strong> Weve designed our platform with you in mind. Our easy-to-navigate interface ensures that accessing resources and tools is intuitive and hassle-free. From submitting your information to exploring your personalized recommendations, every step is straightforward and user-friendly.</li>
            </ul>
            <p className={styles.paragraph}>At Noreg, were more than a service—were a partner in your financial transformation. With the right resources, unwavering support, and a community that has your back, theres no limit to what you can achieve.</p>
          </section>
            ...
            <ul className={styles.list}>
              <li><strong>Track Your Progress:</strong> 
                <ul>
                  ...
                  <li>Customized Adjustments: As your financial situation evolves, well adjust your plan to meet your current needs. Whether you need to address new challenges or leverage new opportunities, our tools adapt to keep you moving forward.</li>
                </ul>
              </li>
          ...
          <section className={styles.section}>
            ...
            <ul className={styles.list}>
              <li><strong>Individuals New to Credit:</strong> If youre just starting to build your credit, our platform offers the guidance and tools you need to establish a strong foundation.</li>
              <li><strong>Those Looking to Rebuild:</strong> If financial setbacks have affected your credit, were here to help you recover with solutions to improve your score and regain control.</li>
            ...
            <ul className={styles.list}>
              ...
              <li>With consistent progress and small wins along the way, well help you turn your financial goals into lasting achievements.</li>
            </ul>
            <p className={styles.paragraph}>
              At Noreg, we dont just promise credit fixes—we deliver real financial transformation. Your journey to better credit starts here, and well be with you every step of the way.
            </p>
            <hr />
          </section>
        </main>
